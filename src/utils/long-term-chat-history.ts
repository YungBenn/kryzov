...
import { getProjectAppRoot } from './app-paths.js';
 ...
 * Stores messages in .kryzov/messages/chat_history.json
 */
export class LongTermChatHistory {
  ...
  constructor(baseDir: string = process.cwd()) {
    this.filePath = join(getProjectAppRoot(baseDir), MESSAGES_DIR, MESSAGES_FILE);
  }
